...
export default function Dashboard() {
  ...
  const handleConfirmSuggestion = async (suggestion: Suggestion) => {
    try {
      const res = await fetch(`/api/persons/${suggestion.personId}`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
    ...
    <div className="min-h-screen bg-gray-50 pb-24">
      ...
      <header className="bg-white border-b sticky top-0 z-10">
        <div className="max-w-md mx-auto px-4 py-3 flex items-center justify-between">
          <h1 className="text-lg font-semibold text-gray-900">师道·人际关系智库</h1>
      ...
      {/* 底部浮动按钮 */}
      <footer className="fixed bottom-16 left-0 right-0 bg-white border-t py-3 px-4 z-40">
