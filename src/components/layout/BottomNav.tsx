...
import { Home, Users, MessageSquare, HelpCircle, BookOpen, Settings } from 'lucide-react';
import { cn } from '@/lib/utils';

const navItems = [
  { href: '/', icon: Home, label: '驾驶舱' },
  { href: '/persons', icon: Users, label: '人物' },
  { href: '/interactions', icon: MessageSquare, label: '记录' },
  { href: '/confusion', icon: HelpCircle, label: '困惑' },
  { href: '/strategies', icon: BookOpen, label: '策略库' },
